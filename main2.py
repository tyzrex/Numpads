...
#     message = ""
#     input_text = str(val)
#     for digit, group in itertools.groupby(input_text):
#         letters = letters_by_pad_number[input_text]
#         presses_number = len(list(group))
#
#         letter_index = (presses_number - 1) % len(letters)
#         message += letters[letter_index]
#     return message
#
# result = number_to_text(input_text)
# print(number_to_text(input_text))
